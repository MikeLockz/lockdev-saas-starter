...
const mockPatients = [
    { id: 'p-1', first_name: 'John', last_name: 'Doe', dob: '1990-01-15', medical_record_number: 'MRN001', enrolled_at: null, status: 'ACTIVE' },
    { id: 'p-2', first_name: 'Jane', last_name: 'Smith', dob: '1985-05-20', medical_record_number: null, enrolled_at: null, status: 'ACTIVE' },
];

const mockProviders = [
    { id: 'prov-1', user_id: 'u1', user_display_name: 'Dr. Smith', user_email: 'smith@example.com', npi_number: null, specialty: 'Internal Medicine', is_active: true },
    { id: 'prov-2', user_id: 'u2', user_display_name: 'Dr. Jones', user_email: 'jones@example.com', npi_number: null, specialty: 'Cardiology', is_active: true },
];
...
describe('AppointmentCreateModal', () => {
    ...
    it('renders modal when open', () => {
        ...
        expect(screen.getByText('Create a new appointment for a patient.')).toBeInTheDocument();
    });
