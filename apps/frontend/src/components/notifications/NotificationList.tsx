...
import { useNotifications, useMarkNotificationRead, useDeleteNotification, useMarkAllNotificationsRead } from "@/hooks/api/useNotifications";
...
export function NotificationList() {
    ...
    const { data, isLoading } = useNotifications(1, 50, filter === "unread" ? false : undefined);
