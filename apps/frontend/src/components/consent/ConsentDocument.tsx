            ...
            <CardContent className="space-y-4">
                <div className="rounded-md border p-4 h-32 overflow-y-auto">
                    <p className="text-sm text-muted-foreground">
                        Please review and accept this consent document to continue using the application.
                        This document covers important terms regarding your use of our healthcare services.
                    </p>
                </div>
