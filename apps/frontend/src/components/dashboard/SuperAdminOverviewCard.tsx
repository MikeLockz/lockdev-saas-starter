...
export function SuperAdminOverviewCard() {
  ...
  const { data: orgsData, isLoading: isOrgsLoading } =
    useSuperAdminOrganizations({ page_size: 5 });
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              {systemHealth?.metrics.total_organizations || 0} organizations ·{" "}
              {systemHealth?.metrics.total_users || 0} users
            </CardDescription>
          </div>
          {lockedUsersCount > 0 && (
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="flex flex-col items-center gap-1 p-3 rounded-md bg-muted/50">
                ...
                <Badge
                  variant={getStatusColor(systemHealth?.db_status || "")}
              ...
              <div className="flex flex-col items-center gap-1 p-3 rounded-md bg-muted/50">
                ...
                <Badge
                  variant={getStatusColor(systemHealth?.redis_status || "")}
                  className="text-xs flex items-center gap-1"
                >
              ...
              <div className="flex flex-col items-center gap-1 p-3 rounded-md bg-muted/50">
                ...
                <Badge
                  variant={getStatusColor(systemHealth?.worker_status || "")}
                  className="text-xs flex items-center gap-1"
                >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-2xl font-bold">
                    {systemHealth?.metrics.total_organizations || 0}
                  </span>
                </div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-2xl font-bold">
                    {systemHealth?.metrics.total_users || 0}
                  </span>
                </div>
                <p className="text-xs text-muted-foreground mt-1">
                  Total Users
