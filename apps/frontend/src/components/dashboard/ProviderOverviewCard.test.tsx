...
const mockUseProviderTodaysAppointments = useProviderTodaysAppointments as ReturnType<typeof vi.fn>;
const mockUseProviderPendingTasks = useProviderPendingTasks as ReturnType<typeof vi.fn>;
...
describe('ProviderOverviewCard', () => {
    ...
    it('renders loading state', () => {
        ...
        expect(screen.getByText('Loading your appointments and tasks...')).toBeInTheDocument();
    });
    ...
    it('renders appointments and tasks', () => {
        ...
        const mockTasks = [
            { id: 'task-1', title: 'Review labs', status: 'TODO', priority: 'URGENT', due_date: null },
            { id: 'task-2', title: 'Sign discharge', status: 'TODO', priority: 'HIGH', due_date: null },
        ];
        ...
        expect(screen.getByText("Today's Schedule")).toBeInTheDocument();
        expect(screen.getByText('2 appointments · 2 pending tasks')).toBeInTheDocument();
    ...
    it('renders empty state when no appointments', () => {
        ...
        expect(screen.getByText("Today's Schedule")).toBeInTheDocument();
        expect(screen.getByText('0 appointments · 0 pending tasks')).toBeInTheDocument();
