...
import { useSuperAdminOrganizations, useUpdateOrganization, useCreateOrganization } from '../../hooks/api/useSuperAdmin';
                            ...
                            <DialogContent>
                                ...
                                <div className="space-y-4 py-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select value={newOrgSubscription} onValueChange={setNewOrgSubscription}>
                                ...
                                <DialogFooter>
                                    ...
                                    <Button onClick={handleCreateOrganization} disabled={createOrg.isPending}>
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                            ...
                                            <TableHead className="whitespace-nowrap">Patients</TableHead>
