...
export function TimezonePreferences() {
  ...
  const updateMutation = useMutation({
    mutationFn: async (timezone: string) => {
      const response = await api.patch("/api/v1/users/me/timezone", {
        timezone,
      });
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Set your preferred timezone for dates and times. If not set, your
          organization's timezone is used.
        </CardDescription>
      </CardHeader>
