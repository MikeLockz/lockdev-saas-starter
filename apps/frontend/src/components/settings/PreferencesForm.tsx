...
export function PreferencesForm() {
  ...
  const handleChange = async (
    field: "transactional_consent" | "marketing_consent",
    value: boolean,
  ) => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Communication Preferences</CardTitle>
        <CardDescription>
          Control how we contact you. Some notifications are required for your
          care.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="flex items-start justify-between p-4 rounded-lg border">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Essential notifications about appointments, billing, and care
              reminders. Required for HIPAA compliance.
            </p>
          </div>
          <Toggle
            checked={preferences?.transactional_consent ?? true}
            onChange={(checked) =>
              handleChange("transactional_consent", checked)
            }
        ...
        <div className="flex items-start justify-between p-4 rounded-lg border">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Updates about new services, health tips, and promotions. You can
              unsubscribe anytime.
            </p>
          </div>
          <Toggle
