...
import { PERMISSION_CATEGORIES, PermissionGroup } from "./PermissionToggle";
...
export function ProxyAssignModal({
  ...
  const [permissions, setPermissions] =
    useState<ProxyPermissions>(DEFAULT_PERMISSIONS);
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {patientName ? `${patientName}'s` : "this patient's"} health
            records.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            ...
            {(
              Object.keys(PERMISSION_CATEGORIES) as Array<
              ...
              <PermissionGroup
                ...
                category={category}
                permissions={
                  permissions as unknown as { [key: string]: boolean }
                }
