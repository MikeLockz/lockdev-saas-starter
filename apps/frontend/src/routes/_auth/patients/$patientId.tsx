                    ...
                    <TabsContent value="overview" className="space-y-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Basic demographics and enrollment details</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <div>
                                        ...
                                        <dd className="text-sm">{patient.legal_sex || 'Not specified'}</dd>
                                    </div>
                                    <div>
                                        <dt className="text-sm font-medium text-muted-foreground">MRN</dt>
                                        <dd className="text-sm font-mono">{patient.medical_record_number || '—'}</dd>
                                    </div>
                                    <div>
                    ...
                    <TabsContent value="contacts" className="space-y-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Phone, email, and communication preferences</CardDescription>
                            </CardHeader>
                            <CardContent>
                                {patient.contact_methods.length === 0 ? (
                                    <p className="text-muted-foreground text-sm">No contact methods on file.</p>
                                ) : (
                    ...
                    <TabsContent value="care-team" className="space-y-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Providers assigned to this patient</CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <TabsContent value="documents" className="space-y-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Upload patient documents to secure storage</CardDescription>
                            </CardHeader>
                            <CardContent>
