...
import { useCreatePatient, type PatientCreate } from '@/hooks/api/usePatients'
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Enter the patient's basic information</CardDescription>
                        </CardHeader>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value: string) => setValue('legal_sex', value)}
                                    >
                                        <SelectTrigger>
