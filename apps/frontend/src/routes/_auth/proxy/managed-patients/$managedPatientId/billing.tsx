...
interface ProxySubscriptionManagerProps {
...
function ManagedPatientBillingDetail() {
  ...
  const { data: subscription, isLoading } =
    useManagedPatientSubscription(managedPatientId);
...
import {
  useManagedPatientTransactions,
  useProxyCancelSubscription,
  useProxyCheckout,
} from "@/hooks/api/useProxyBilling";
import { formatCurrency, formatDate } from "@/lib/utils";

function ProxySubscriptionManager({
  subscription,
  patientId,
}: ProxySubscriptionManagerProps) {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This patient doesn't have an active subscription. Choose a plan
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    You can cancel the subscription immediately or at the end of
