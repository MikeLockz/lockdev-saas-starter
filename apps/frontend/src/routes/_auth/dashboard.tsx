...
function Dashboard() {
  ...
  const { data: appointmentsToday, isLoading: isApptsLoading } =
    useTodaysAppointmentsCount();
  const { data: unreadNotifications, isLoading: isNotifLoading } =
    useUnreadCount();
  const { data: activeSessions, isLoading: isSessionsLoading } =
    useActiveSessionsCount();
  ...
  const stats = [
    ...
    },
    {
      ...
      value: isNotifLoading
        ? "-"
        : (unreadNotifications?.count?.toString() ?? "0"),
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 lg:grid-cols-7">
            ...
            {roleInfo?.role === "super_admin" ? (
              ...
              <PatientOverviewCard patientId={roleInfo.patientId} />
