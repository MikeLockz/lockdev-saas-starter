...
export type src__schemas__organizations__OrganizationCreate =
  components["schemas"]["src__schemas__organizations__OrganizationCreate"];
export type src__schemas__organizations__OrganizationUpdate =
  components["schemas"]["src__schemas__organizations__OrganizationUpdate"];
