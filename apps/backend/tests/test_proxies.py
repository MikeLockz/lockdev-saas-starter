...
class TestProxyAPI:
    ...
    @pytest.mark.asyncio
    async def test_assign_proxy(self, authenticated_client, test_org, test_patient, proxy_user):
        ...
        response = await authenticated_client.post(
            f"/api/v1/organizations/{test_org.id}/patients/{test_patient.id}/proxies", json=data
        )
    ...
    @pytest.mark.asyncio
    async def test_list_patient_proxies(self, authenticated_client, test_org, test_patient, proxy_user):
    ...
    @pytest.mark.asyncio
    async def test_update_proxy_permissions(self, authenticated_client, test_org, test_patient, proxy_user):
        ...
        response = await authenticated_client.patch(
            ...
            json={"permissions": {"can_view_clinical_notes": True, "can_message_providers": True}},
        )
    ...
    @pytest.mark.asyncio
    async def test_revoke_proxy(self, authenticated_client, test_org, test_patient, proxy_user):
    ...
    @pytest.mark.asyncio
    async def test_duplicate_proxy_rejected(self, authenticated_client, test_org, test_patient, proxy_user):
    ...
    @pytest.mark.asyncio
    async def test_proxy_not_found_user(self, authenticated_client, test_org, test_patient):
...
class TestProxyDashboard:
    ...
    @pytest.mark.asyncio
    async def test_my_proxy_patients(self, client, db_session, test_org, test_patient, proxy_user):
