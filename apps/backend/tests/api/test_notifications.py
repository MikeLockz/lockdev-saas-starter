...
@pytest.mark.asyncio
async def test_list_notifications(client: AsyncClient, test_user_token_headers: dict, user_notification: Notification):
...
@pytest.mark.asyncio
async def test_get_unread_count(client: AsyncClient, test_user_token_headers: dict, user_notification: Notification):
    response = await client.get(
...
@pytest.mark.asyncio
async def test_mark_as_read(client: AsyncClient, test_user_token_headers: dict, user_notification: Notification):
...
@pytest.mark.asyncio
async def test_mark_as_unread(client: AsyncClient, test_user_token_headers: dict, user_notification: Notification):
    # First mark as read
...
async def test_mark_all_read(
    client: AsyncClient, test_user_token_headers: dict, user_notification: Notification, db_session
):
