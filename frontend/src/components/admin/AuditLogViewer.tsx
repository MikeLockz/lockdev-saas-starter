...
import { useAuditLogs, exportAuditLogs } from '../../hooks/api/useAuditLogs';
...
const ACTION_TYPES = ['READ', 'CREATE', 'UPDATE', 'DELETE', 'IMPERSONATE', 'EXPORT'];
const RESOURCE_TYPES = ['PATIENT', 'USER', 'APPOINTMENT', 'DOCUMENT', 'ORGANIZATION', 'AUDIT_LOG'];
                            ...
                            <div className="mt-4 flex items-center justify-between text-sm text-muted-foreground">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        disabled={(data?.items.length || 0) < (filters.page_size || 50)}
                                        onClick={() => setFilters({ ...filters, page: (filters.page || 1) + 1 })}
                                    >
                                        Next
                                    </Button>
