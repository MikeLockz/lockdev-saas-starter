...
export function ProxyPatientCard({ proxyPatient }: ProxyPatientCardProps) {
    ...
    const quickActions = [
        { key: "profile", label: "Profile", icon: User, enabled: permissions.can_view_profile },
        { key: "appointments", label: "Appointments", icon: Calendar, enabled: permissions.can_view_appointments },
        { key: "records", label: "Records", icon: Eye, enabled: permissions.can_view_clinical_notes },
        { key: "messages", label: "Messages", icon: MessageSquare, enabled: permissions.can_message_providers },
    ];
