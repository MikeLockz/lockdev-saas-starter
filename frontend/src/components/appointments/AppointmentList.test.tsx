...
const mockProviders = [
    { id: 'prov-1', user_id: 'u1', user_display_name: 'Dr. Smith', user_email: 'smith@example.com', npi_number: null, specialty: null, is_active: true },
    { id: 'prov-2', user_id: 'u2', user_display_name: 'Dr. Jones', user_email: 'jones@example.com', npi_number: null, specialty: null, is_active: true },
];
